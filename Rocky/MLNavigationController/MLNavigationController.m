...
//        url = [url URLByAppendingPathComponent:@"1stVPlus Database"];
//        self.VPlusData = [[UIManagedDocument alloc] initWithFileURL:url];
////        navigation.VPlusData = instagramDocument;
//    }
}
...
- (UIViewController *)popViewControllerAnimated:(BOOL)animated
{
    ...
    [[Tool getTheWebConnect] CancleNetWorkWithDelegate:vc];
    return vc;
}
